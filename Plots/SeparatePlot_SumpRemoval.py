...
FileDir = {"Reactor1":'/media/pi/One Touch/Seagate/raspberrypi/Biotrickling_filter_data/log2021/Reactor1/master.csv',
                 "Reactor2":'/media/pi/One Touch/Seagate/raspberrypi/Biotrickling_filter_data/log2021/Reactor2/sump/master_SumpRemoval.csv',
...
for i in range(1,4):
    ...
    # calculating biotrickling sump parameters:
    Vempty = 517
    Vhead = 200 #ml
    Vliq = 800 #ml
    # empty bed residence time calculation
    GRT = Vhead/RFlow # gas residence time in sump head space units: min
    EBRT = Vempty/RFlow
